...
class MutableDocumentComposer extends DocumentComposer implements Editable {
  ...
  // USERNOTE: The Editable items (like your MutableDocumentComposer) stop firing change notifications when a transaction starts and only notify once at the very end when the entire atomic change set is complete.
  @override
